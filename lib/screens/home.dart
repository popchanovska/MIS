...
class _HomeState extends State<Home> {
  List<Clothing> clothing = [
    Clothing(
      ...
      desc: "Comfortable and stylish hoodie for casual wear.",
      price: 79.99,
    ),
    Clothing(
      id: 2,
      ...
      desc: "Lightweight jacket with UV protection for outdoor activities.",
      price: 99.99,
    ),
    Clothing(
      id: 3,
      ...
      desc: "Versatile shorts for workouts or lounging.",
      price: 34.99,
    ),
    Clothing(
      id: 4,
      ...
      desc: "Modern running shoes designed for speed and comfort.",
      price: 119.99,
    ),
    Clothing(
      id: 5,
      ...
      desc: "Trail running shoes with superior grip and cushioning.",
      price: 159.99,
    ),
    Clothing(
      id: 6,
      ...
      desc: "Soft cropped tank for a relaxed and chill look.",
      price: 49.99,
    ),
    Clothing(
      id: 7,
      ...
      desc: "Classic sportswear top for everyday wear.",
      price: 39.99,
    ),
    Clothing(
      id: 8,
      ...
      desc: "Stylish collaboration with Jacquemus for a sleek look.",
      price: 89.99,
    ),
  ];
